...
export type Capability = {
  ...
  title: string;
  description: string;
  /** A short, concrete proof point shown under the description. */
  proof?: string;
  stack: string;
};
...
export type NowItem = { context: string; text: string };

export type Project = {
  meta: string;
  title: string;
  description: string;
  /** Optional measurable outcome — shown as "Impact: ..." */
  impact?: string;
  tags: string;
  /** Featured projects render as larger cards; INTERNAL-only ones
   *  go into a compact secondary list. */
  featured?: boolean;
};
...
export type Content = {
  ...
  hero: {
    ...
    slogan: string;
    intro: string;
    /** Small green-dot status pill: "Open to ... · Taipei / Remote" */
    availability: string;
    ctaPrimary: string;
    ctaSecondary: string;
  };
  ...
  cta: {
    ...
    slogan: string;
    paragraph: string;
    /** Standalone "Available for" line shown above the slogan. */
    availability: string;
    ctaPrimary: string;
    ctaSecondary: string;
  };
...
export const content: Record<Lang, Content> = {
  en: {
    ...
    hero: {
      ...
      availability:
        "Open to senior PM / Marketing Ops / Product roles · Taipei · Remote-friendly",
    ...
    now: {
      ...
      items: [
        { context: "TKB", text: "Language-school CMS" },
        { context: "Joysee", text: "Event system" },
        { context: "Side", text: "Market system" },
        { context: "Personal", text: "Cursor + Claude Code workflow" },
        { context: "Joysee", text: "Indoor event prep" },
      ],
    },
    capabilities: {
      kicker: "What I do",
      ...
      items: [
        {
          ...
          proof: "Recent: 260 leads / NT$1M+ first-quarter revenue",
        ...
        },
        {
          ...
          proof: "Recent: 6 internal systems shipped solo",
        ...
        },
        {
          ...
          proof: "Recent: 3-week booth recruitment system, live at 2 events × 30 booths / month",
        ...
        },
        {
          ...
          proof: "Scale: ~60 booths handled across 2 events per month",
        ...
        },
        {
          ...
          proof: "Joysee: 2,400+ Threads · 500+ event attendees · 60% female",
      ...
      items: [
        {
          ...
          impact: "Built solo, from data model to deployment.",
        ...
        },
        {
          ...
          impact: "Powers Joysee's 5–7 events / year for 500+ cumulative attendees.",
        ...
        },
        {
          ...
          impact: "TKB Threads grew 25× (69 → 1,700 followers in one year).",
        ...
        },
        {
          ...
          impact: "Replaced scattered Drive folders + Sheets with one trackable pipeline.",
        ...
        },
        {
          ...
          impact: "Keeps internal cost data from leaving the building.",
        ...
        },
        {
          ...
          impact: "Cuts consultant prep time per school visit.",
        ...
        },
        {
          ...
          impact: "3-week delivery; supports 2 events × 30 booths per month.",
      ...
      items: [
        {
          ...
          bullets: [
            ...
            "Shipped **6 internal systems** end to end (React + Firebase + Supabase + Google Apps Script + AI APIs), covering vendor lifecycle management, AI-generated content CMS, dual-version quotation automation and multi-account social analytics — including a booth recruitment system delivered in **3 weeks** for a recurring **2 events × 30 booths / month** cadence.",
    ...
    cta: {
      ...
      availability:
        "Available for senior PM / Marketing Ops / Product roles and consulting engagements · Taipei · Remote-friendly",
      paragraph:
  ...
  zh: {
    ...
    hero: {
      ...
      availability:
        "Open to · Senior PM / Marketing Ops / Product · Taipei · 接受 Remote",
      ctaPrimary: "看看我的作品",
      ctaSecondary: "跟我聊聊",
    },
    now: {
      ...
      prefix: "正在做",
      items: [
        { context: "TKB", text: "語校 CMS" },
        { context: "Joysee", text: "活動系統" },
        { context: "Side", text: "市集系統" },
        { context: "Personal", text: "Cursor + Claude Code workflow" },
        { context: "Joysee", text: "室內活動籌備" },
      ],
    },
    capabilities: {
      kicker: "我能做什麼",
      ...
      items: [
        ...
        },
        {
          ...
          proof: "最近：招商系統 3 週上線，每月 2 場 × 30 攤",
          stack: "TypeScript · React · Tailwind · PostgreSQL",
        },
        {
          icon: "handshake",
        ...
        },
        {
          ...
          proof: "Joysee：2,400+ Threads · 500+ 參與者 · 60% 女性",
          stack: "LINE Bot · LIFF · Threads · Instagram · Figma",
        },
      ],
    },
    ...
    projects: {
      ...
      items: [
        ...
        },
        {
          ...
          impact: "撐住 Joysee 每年 5–7 場、累計 500+ 參與者的活動節奏。",
          tags: "liff · edge functions · tally · supabase · line bot",
          featured: true,
        },
        {
          ...
          impact: "TKB Threads 一年從 69 拉到 1,700 追蹤（25×）。",
          tags: "gas · threads api · sheets · claude api",
          featured: true,
        },
        {
          ...
          impact: "把散落的 Drive / Sheets 收成一條可追蹤的流程。",
          tags: "react · firebase · gas · claude api · drive api",
        },
        {
          meta: "INTERNAL · 2024",
      ...
      items: [
        {
          ...
          bullets: [
            ...
            "任職期間 ship **6 套**內部系統（React + Firebase + Supabase + GAS + AI APIs），涵蓋廠商生命週期管理、AI 內容 CMS、雙版本報價自動化、多帳號社群數據監控；其中招商系統 **3 週**上線，支援每月 **2 場 × 30 攤**的活動節奏。",
            "把公司 Threads 帳號一年拉到 **25 倍**成長（69 → 1,700 追蹤），也從零做起校園大使制度，包含招募和執行規則。",
          ],
        },
        {
          year: "2023–",
          ...
          bullets: [
            "創辦揪西歡玩 Joysee Travel，從戶外揪團社群慢慢跑成固定活動品牌。每年 **5–7 場**主題活動，累計 **500+** 參與者；Threads **2,400+** 追蹤，女性受眾 **60%**，在運動／戶外社群裡算少見。",
        ...
        },
        {
          ...
          bullets: [
            ...
            "跑過活動、內容、社群等創業實驗，包含 **10 場**大型社交活動、**500+** 參與者，以及每月自然流量破 **10 萬次**的內容專案。",
          ],
        },
        {
          year: "2021–2023",
    ...
    cta: {
      ...
      slogan: "來做點有用的東西吧。",
      availability:
        "目前接受 senior PM、Marketing Ops、Product 主管職位，以及顧問合作 · Taipei 為主 · 可 Remote",
      paragraph:
